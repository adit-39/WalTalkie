...
public class Utils {
	...
	public static String IP = "http://107.167.182.15";
	...
	public static String removeItem(String item, String list) {
		...
		for (int i = 0; i < arr.length; i++) {
			if ((!arr[i].equals(item))) {
				result += arr[i] + ",";
				if(i<FormsFragment.price_items.size())
					price += FormsFragment.price_items.get(i);
				if(i<FormsFragment.qty_items.size())
					qty += FormsFragment.qty_items.get(i);
			} 
		}
		if(result.endsWith(","))
		{
